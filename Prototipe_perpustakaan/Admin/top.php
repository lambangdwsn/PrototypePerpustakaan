...
<link rel="stylesheet" type="text/css" href="tabel-zebra.css">
<style>
body {
  margin: 0;
...
<div class="sidebar" id="mysidebar">
 <h1 style="color: white;text-align: center;">Perpustakaan</h1>
  <a class="active" href="utama.php">Home</a>
  <a href="data_buku.php">Data Buku</a>
  <a href="data_anggota.php">Data Anggota</a>
  <a href="data_pegawai.php">Data Pegawai</a>
  <a href="input_pinjam.php">Peminjaman</a>
  <a href="input_pengembalian.php">Pemengembalian</a>
  <a href="profile.php">Profil Anda</a>
